...
#include "dynamic_planner/graph_msger_far.h"

/***************************************************************************************/

void GraphMsgerFAR::Init(const ros::NodeHandle& nh, const GraphMsgerFARParams& params) {
    nh_ = nh;
    gm_params_ = params;
    graph_pub_ = nh_.advertise<visibility_graph_msg::Graph>("/robot_vgraph", 5);
    graph_sub_ = nh_.subscribe("/decoded_vgraph", 5, &GraphMsgerFAR::GraphCallBack, this);
...
// void GraphMsgerFAR::EncodeGraph(const NodePtrStack& graphIn, visibility_graph_msg::Graph& graphOut) {
...
// void GraphMsgerFAR::UpdateGlobalGraph(const NodePtrStack& graph) {
//     global_graph_ = graph;
...
// void GraphMsgerFAR::PublishGlobalGraph(const NodePtrStack& graphIn) {
...
// void GraphMsgerFAR::GraphCallBack(const nav_graph_msg::GraphConstPtr& msg) {
//     if (msg->nodes.empty()) return;
//     NodePtrStack decoded_nodes;
//     const std::size_t robot_id = msg->robot_id;
//     const visibility_graph_msg::Graph graph_msg = nav2vis(msg);
...
// NavNodePtr GraphMsgerFAR::NearestNodePtrOnGraph(Point3D p, float radius) {
...
// void GraphMsgerFAR::CreateDecodedNavNode(const visibility_graph_msg::Node& vnode, NavNodePtr& node_ptr) {
...
// void GraphMsgerFAR::ExtractConnectIdxs(const visibility_graph_msg::Node& node,
